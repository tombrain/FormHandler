...
class UploadField extends Field
{
    ...
    {
        return ($this->_oForm->isPosted() && # form is posted
    ...
    public function isValid()
    {
        ...
        if (
            strtolower($this->_aConfig['exists']) == 'alert' &&  # do we have to alert the user ?
            $aFile['error'] == 0 && # check if the file is succesfully uploaded
            file_exists($this->_aConfig['path'] . $this->_getFilename(true))
